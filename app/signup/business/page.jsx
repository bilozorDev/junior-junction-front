            ...
            <form>
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-gray-900">Business Infomation</h2>
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="col-span-full">
                                ...
                                <p className="mt-3 text-sm leading-6 text-gray-600">Write a few sentences about the businesss.</p>
                            </div>
                            ...
                            <div className="col-span-full">
                                <label htmlFor="business-image" className="block text-sm font-medium leading-6 text-gray-900">
                                    Business Image
                                </label>
